                    ...
                    <div class="card float-center">
                        <div class="card-body">
                            ...
                            <div class="col-12">
                                ...
                                <input type="number" name="loanA" value="" class="form-control" id="loanA"
                                    required>
                            </div>
                            <div class="col-12">
                                <label for="tenure" class="form-label">Tenure (in Months)</label>
                                <input type="number" name="tenure" value="12" class="form-control" id="tenure"
                                    required>
                            </div>
                            <div class="col-12">
                                <label for="interest" class="form-label">Interest (in Yearly %)</label>
                                <input type="number" name="interest" value="12" class="form-control" id="interest"
                                    required>
                            </div>
                            <div class="col-12">
    ...
    <script>
        $(function() {
            $(".form-control").change(function() {
                ...
                var EMI = loanA * (MonthlyIntRate * (MonthlyIntRate_cal ** tenure)) / ((
                    MonthlyIntRate_cal ** tenure) - 1);
                ...
                for (i = 0; i < tenure; i++) {
                    ...
                    Interst.push(MonthlyInt.toFixed(2));
                    Principal.push(MonthlyPrincipal.toFixed(2));
                    Tenure.push(i + 1);
